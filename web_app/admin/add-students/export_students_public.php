...
if (isset($_POST['selected_students']) && !empty($_POST['selected_students'])) {
    ...
    // ถ้าไม่มีการเลือกนักศึกษาใดๆ ให้เปลี่ยนเส้นทางไปที่หน้า student_public.php พร้อมส่งข้อความแจ้งเตือน
    header("Location: student_public.php?error=no_students_selected");
    exit();
}
